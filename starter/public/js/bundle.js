...
exports.hideAlert = exports.callAlert = void 0;
...
var callAlert = function callAlert(type, msg) {
  hideAlert();
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.callAlert)('success', 'Login successfuly');
          ...
          case 7:
            ...
            (0, _alert.callAlert)('error', _context.t0.response.data.message);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            (0, _alert.callAlert)('error', 'Error when logout ! Please try again');
...
},{"axios":"../../node_modules/axios/index.js","./alert.js":"alert.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibmFydXRvc2ltYWhhIiwiYSI6ImNrdnlxcGx1bzNvem4ydW1vcXRlb2llbGIifQ.i4PGkgd0am0o2o8QaI8wsQ';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.callAlert)('success', 'Data update successfully 💗');
            }
...
var _updateUserData = require("./updateUserData.js");
...
var logoutButton = document.querySelector('.nav__el.nav__el--logout');
var updateForm = document.querySelector('.form.form-user-data');
var updatePassword = document.querySelector('.form.form-user-settings');
...
if (updateForm) {
  updateForm.addEventListener('submit', function (e) {
    ...
    (0, _updateUserData.updateSettings)(data, 'data');
  });
}
...
if (updatePassword) {
  updatePassword.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var passwordConfirm, currentPassword, newPassword;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              document.querySelector('.form.form-user-settings .btn.btn--small.btn--green').textContent = 'Saving...';
              ...
              _context.next = 8;
              return (0, _updateUserData.updateSettings)({
            ...
            case 8:
              document.querySelector('.form.form-user-settings .btn.btn--small.btn--green').textContent = 'Save password';
